// server/test-p6-final.js
// Final test with Oracle P6 RESTAPI standard endpoints
...
async function testP6API() {
    console.log('='.repeat(80));
    console.log('Testing Oracle P6 RESTAPI Endpoints');
    console.log('='.repeat(80));
    console.log('');

    try {
        // Test /restapi/project endpoint
        console.log('Testing: /restapi/project');
        const response = await axios.get(`${BASE_URL}/restapi/project`, {
            headers: {
